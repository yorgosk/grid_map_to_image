...
parser = argparse.ArgumentParser(description='Give me .png paths')
...
print("FLANN based matcher - SIFT")
...
# Feature Matching - SIFT + Homography
print("Feature Matching + Homography")
